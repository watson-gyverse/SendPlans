...
import { ThreeStep, ThreeStepComma } from '../Style/const'
        ...
        <MobileBackground>
          ...
          <MobileBody>
            ...
            <HorizonDiv>
              <>
                <h4>
                  현재 진행 중인 숙성과정을<br></br>종료처리 할 수 있습니다
                  <br />
                  (※조회가 안 될 경우, <br></br>'조회'버튼을 한 번 더
                  클릭해주세요)
                </h4>
              </>
            </HorizonDiv>
    ...
    if (data.afterWeight === 0) {
      setDataArray((arr: any) => [
        ...arr,
        {
          ...
          beforeWeight: ThreeStepComma(data.beforeWeight.toString()) + 'g',
          startDate: new Date(data.startDate.seconds * 1000).toLocaleDateString(
            'ko-Kr',
            {
              year: 'numeric',
              month: 'numeric',
