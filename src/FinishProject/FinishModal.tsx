  ...
  return (
    ...
    >
      <div>
        ...
        <HorizonDiv>
          <h3 style={{ margin: '0', width: '16rem' }}>숙성종료일 설정 : </h3>
          <DatePickerComponent
        ...
        <h3>
          냉장고: {checkValues.fridgeNum} , 층: {checkValues.machineNum}
        </h3>
        <h3>
          {checkValues.species} , {checkValues.cut} , {checkValues.country} ,{' '}
          {checkValues.grade + '(등급)'}
        </h3>
        ...
        <br />
        <HorizonDiv>
          <StyledButton onClick={handleClickSubmit}>제출</StyledButton>
          <StyledButton onClick={handleClickCancel}>닫기</StyledButton>
        </HorizonDiv>
        <br />
      </div>
    </ReactModal>
